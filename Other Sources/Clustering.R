...
# The decision of merging two clusters is taken on the basis of closeness of these clusters. There are multiple metrics for deciding the closeness of two clusters :
  # Euclidean distance: ||a-b||2 = sqrt(Summation(ai-bi))
...
############################################################
# 1. Hierarchical clustering cannot handle big data well but K Means clustering can. This is because the time complexity of K Means is linear i.e. O(n) while that of hierarchical clustering is quadratic i.e. O(n2).
